...
def init_app(app):
    ...
    def newsletter():
        try:
            ...
            Thank you for choosing Pamantasan PH as your trusted partner in discovering educational institutions that offer 
            programs tailored to your interests and career goals. We're excited to continue this journey with you and can't 
            wait to reveal the exciting updates that lie ahead! 
            
            Here at Pamantasan PH, we understand the importance of providing a good and productive experience for our users. 
            That's why we've been hard at work behind the scenes to ensure that every update and enhancement we introduce is 
